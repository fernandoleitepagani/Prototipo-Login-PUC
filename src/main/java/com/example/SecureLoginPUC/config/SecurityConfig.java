...
public class SecurityConfig {
    ...
    public SecurityConfig(UserConfig userConfig, RecaptchaFilter recaptchaFilter) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/recoverpasswordsms").permitAll()
                        .requestMatchers(HttpMethod.POST, "/recoverpasswordsms").permitAll()
                        .requestMatchers(HttpMethod.GET, "/resetpasswordsms").permitAll()
